  ...
  return (
    <section>
      ...
      <p>
        ...
        {' '}
        <code>unmountOnExit</code>
        {' '}
        flag and
        {' '}
        <code>addEndListener</code>
        {' '}
        event listener.
      </p>
      <p>
        There is also a fallback mechanism controlled with the
        {' '}
        <code>timeout</code>
        {' '}
        prop to signal the ending of the animations forcefully.
      </p>
      <p>
        ⚠️ When using the
        {' '}
        <code>addEndListener</code>
        {' '}
        handler, do not forget to use the correct native JavaScript event listener inside the handler. If you are using CSS
        {' '}
        <code>transition</code>
        {' '}
        property for the animations then listen to the
        {' '}
        <code>transitionend</code>
        {' '}
        event. If you are using CSS
        {' '}
        <code>animation</code>
        {' '}
        then listen to the
      ...
      <p>
        ...
        <code>
          ...
          {JSON.stringify(isVisibleReactTransitionGroup)}
        </code>
      </p>
