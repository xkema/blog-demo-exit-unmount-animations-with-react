  ...
  return (
    <section>
      ...
      <p>
        ...
        . The only notable limitation of the component is animated components have to be the direct children of the
        {' '}
        <code>&lt;AnimatePresence /&gt;</code>
        . (It happens to be a React limitation originally.) Then it is some kind of magic.
      </p>

      <p>
        Actually it is not that magic. 😄 But the developers did a really great job. Instead of controlling a flag like
        {' '}
        <code>isVisible</code>
        , the component keep track of all the children if they are exiting from the React tree by looping through the direct children.
      </p>
      ...
      <p>
        ...
        <code>AnimatePresence</code>
        {' '}
        is just for demonstration purposes. No need for it!
      </p>
      ...
      <p>
        ...
        <code>
          ...
          {JSON.stringify(isVisibleFramerMotion)}
        </code>
      </p>
